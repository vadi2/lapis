...
application at the same time, as well as allow your application to use any ngx.*
features, if you use any. This will very closely resemble how your application
